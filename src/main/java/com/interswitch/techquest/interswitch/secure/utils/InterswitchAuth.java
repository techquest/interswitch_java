...
public class InterswitchAuth {
	...
	public static HashMap<String, String> generateInterswitchAuth(
			...
			String signatureMethod,String authType,String environment) throws Exception {
...
//		System.out.println("Cipher: " + signatureCipher);
		...
		{
			String bearerAuthorization = getAccessToken(clientId, clientSecretKey, environment);
			interswitchAuth.put(AUTHORIZATION, AUTHORIZATION_REALM_BEARER+" "+bearerAuthorization);
		}else
		{
    ...
    public static String getAccessToken(String clientId, String clientSecret,String environment) throws Exception
    {
		...
		System.out.println("\nSending 'POST' request to URL : " + PASSPORT_RESOURCE_URL);
		HttpURLConnection con = (HttpURLConnection) obj.openConnection();
		con.setRequestMethod("POST");
		String basicAuthCipher = clientId + ":" + clientSecret;
		String basicAuth = new String(org.bouncycastle.util.encoders.Base64.encode(basicAuthCipher.getBytes()));
