...
public class TransactionSecurity {
    ...
    public static HashMap<String, String> getSecureData(String publicCertPath, String pan, String expDate, String cvv, String pin, String... transactionParameters) throws Exception {
