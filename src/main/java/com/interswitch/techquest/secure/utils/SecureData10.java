...
public class SecureData10 {
	...
	public String getPINBlock(String pin, String cvv2, String expiryDate, byte[] keyBytes) {
	...
	public String getSecure(String publicKeyModulus, String publicKeyExponent, byte[] keyBytes, String pan) {
	...
	public String getSecureV2(String publicKeyModulus, String publicKeyExponent, byte[] keyBytes, String pan,
			String susbscriberID, String transCode,String amt,String phoneNum,String custNum,String paymentItemCode,String cardName) {
        byte[] secureBytes = new byte[64];
        byte[] headerBytes = new byte[1];
        byte[] formatVersionBytes = new byte[1];
        byte[] macVersionBytes = new byte[1];
        ...
        String macData = this.getMACDataVersion9(susbscriberID,cardName, transCode, amt, phoneNum, custNum, paymentItemCode);
	 ...
	 private String getMACDataVersion9(String susbscriberID,String cardName, String transCode,String amt,String phoneNum,String custNum,String paymentItemCode) 
	    {
	        String macData = "";
	 ...
	 private String getMAC(String macData, byte[] macKey, int macVersion) {
	        byte[] macBytes = new byte[4];
